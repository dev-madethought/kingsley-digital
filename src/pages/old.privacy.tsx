    ...
    <Container css={{ paddingTop: 200 }}>
      ...
      >
        ...
        >
          ...
          <Text>
            ...
            provide a service to you. It is collected by lawful means, and with
          ...
          <Text>
            ...
            with third-parties, except when we are required to do so by law. We
            protect the data we store within commercially acceptable means to
            prevent loss and theft, as well as unauthorized access, copying,
            disclosure, use or modification. Our website may be linked to
            external sites that we do not own and are not operated by us. Please
            be aware that we have no control over the content and practices of
            these external sites, and thus unable to accept responsibility or
      ...
      >
        ...
        >
          ...
          <Text>
            우리는 법에 따라 요구되는 경우를 제외하고 개인식별정보를 공개하거나
            제3자와 공유하지 않습니다. 우리는 이용자 데이터의 무단 액세스, 복사,
            공개, 사용 및 수정, 손실 및 도난을 방지하기 위해 상업적으로 허용된
            수단으로써 저장된 데이터를 보호합니다. 이 웹사이트는 우리 소유가
            아닌 외부 사이트에 링크될 수 있습니다. 우리는 이러한 외부 사이트의
            내용 및 관행을 제어할 수 없음으로 각 개인정보 보호정책에 대한 책임을
            지지 않습니다.
          </Text>

          <Text>
            이용자는 개인정보에 대한 당사의 요청을 거절할 수 있으며 거절 시 일부
            서비스를 이용할 수 없습니다. 이 웹사이트를 계속 사용하는 것은
            이용자가 우리의 개인정보 및 개인정보에 대한 관행을 수락하는 것으로
            간주합니다. 우리의 개인정보 처리방침에 대해 더 궁금한 점이 있는 경우
            언제든지 문의해 주십시오.
          </Text>
        </Box>
      </Box>
